    ...
    namespace API
    {
        ...
        public class Movement : MovementComponent
        {
            ...
            public class ManualDriveComponent : MovementComponent
            {
                ...
                public void RotateRight90(int speed) { Request("18" + "&drive=" + "18" + "&speed=" + speed.ToString() + "&angle=" + "7"); }

                public void RotateLeft90(int speed) { Request("18" + "&drive=" + "17" + "&speed=" + speed.ToString() + "&angle=" + "7"); }
